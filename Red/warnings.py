    ...
    async def warn(
        ...
        *,
        ...
        if dm:
            ...
            em.add_field(name=_("Appeals"), value=_(f"If you feel you have been warned unfairly, or an extended period of time has passed since the warn, you may reply to appeal it here. You will then be given access to a channel to make a proper appeal."), inline=False,)
            try:
                await member.send(
